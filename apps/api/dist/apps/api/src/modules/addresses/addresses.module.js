...
exports.AddressesModule = AddressesModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [addresses_service_1.AddressesService, geocoding_service_1.GeocodingService],
        exports: [addresses_service_1.AddressesService, geocoding_service_1.GeocodingService],
    })
], AddressesModule);
