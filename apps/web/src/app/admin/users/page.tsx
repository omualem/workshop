...
export default function AdminUsersPage() {
  return (
    <DashboardShell title="משתמשים" subtitle="Renters, lenders, admins וסטטוסי אימות." navItems={navItems}>
      <Card className="text-sm leading-7 text-slate-600">טבלאות משתמשים, role management וסטטוס moderation.</Card>
    </DashboardShell>
  );
}
