...
export default function LenderListingsPage() {
  return (
    <DashboardShell title="ניהול פריטים" subtitle="הוספה ועריכה של פריטים, תמונות, מאפיינים והמלצות לשיפור איכות ההצגה." navItems={navItems} activeHref="/lender/listings">
